...
function setType(type) {
    activeType = type;
    document.getElementById("toggleElders").className =
        "toggle-btn" + (type === "elders" ? " active-elders" : "");
    document.getElementById("toggleSisters").className =
        "toggle-btn" + (type === "sisters" ? " active-sisters" : "");
...
function openEditModal(props, id) {
    ...
    document.getElementById("edit_missionary_type").value =
        props.missionary_type;
    document.getElementById("edit_description").value = props.description || "";
    document.getElementById("editPersonLabel").textContent =
